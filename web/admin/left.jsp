...
<div class="dtree">
	...
	<script type="text/javascript">
		...
		d.add('010101','0101','用户管理','${pageContext.request.contextPath}/adminUser?method=findAll','','mainFrame');
        ...
        d.add('010701','0107','公告列表','${pageContext.request.contextPath}/adminNote?method=findAll','','mainFrame');
        d.add('010702','0107','公告添加','${pageContext.request.contextPath}/adminNote?method=addUI','','mainFrame');
		document.write(d);
